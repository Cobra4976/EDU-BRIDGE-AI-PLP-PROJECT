      ...
      <div className={`min-h-screen flex items-center justify-center ${bg} px-4`}>
       {/* <div className={`flex justify-center items-center min-h-screen ${bg} px-4`}> */}
        {/* <div className={`w-full max-w-md ${card} p-8 rounded-2xl`}> */}
          ...
          {isLogin && (
            <div className="mt-4 mb-6">
              <button
                ...
                className="text-[#2e7d32] hover:text-[#43a047] font-medium text-sm"
              >
                Forgot password?
              </button>
            </div>
          ...
          <p className="mt-6 text-sm text-gray-700 flex justify-center items-center gap-2">
            ...
            <button
              ...
              className="text-[#2e7d32] hover:text-[#43a047] ml-2 font-semibold"
            >
    ...
    return (
      ...
      {/* <div className={`flex justify-center items-center min-h-screen ${bg} px-4`}> */}
        ...
        <div className={`w-full max-w-md ${card} p-6 rounded-2xl shadow-lg`}>
          ...
          <button
            onClick={() => setStep(1)}
            className="w-full py-3 rounded-lg border-2 border-gray-300 hover:bg-gray-50 text-[#2e7d32] font-medium transition-colors"
          >
            Back
          </button>
        </div>
    ...
    return (
      ...
      {/* <div className={`flex justify-center items-center min-h-screen ${bg} px-4 py-8`}> */}
        ...
        <div className={`w-full max-w-md ${card} p-6 rounded-2xl shadow-lg`}>
          ...
          <button
            onClick={() => setStep(2)}
            className="w-full py-3 mt-3 rounded-lg border-2 border-gray-300 hover:bg-gray-50 text-[#2e7d32] font-medium transition-colors"
          >
            Back
          </button>
        </div>
